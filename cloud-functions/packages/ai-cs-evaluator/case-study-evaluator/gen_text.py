from gpt_call import generate_section_gpt, generate_summary_gpt, generate_candidate_task_gpt, extract_point_of_views_gpt, extract_target_audience_gpt
from schema import CommunicationsExamInfo
from util import read_docx, case_study_extract, fetch_prompt_message
...
def generate_full_text(candidate_response: str, exam_doc_path: str) -> str:
    ...
    observations, tips = generate_evaluation_text(candidate_response, exam_info)

    # generate summary text
    summary_text = generate_summary_gpt(observations + "\n\n" + tips)

    return summary_text, observations, tips
