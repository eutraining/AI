...
class Evaluation:
    def __init__(self):
        self.df = pd.read_csv("./dataset_files/test.csv")
        self.overall_score = pd.read_csv("./predicted_files/singleton/summary/overall_score_gpt3.5_sample_15.csv")
        self.communication_score = pd.read_csv(
            "./predicted_files/singleton/summary/communication_score_gpt3.5_sample_15.csv")
        self.overall_summary = pd.read_csv("./predicted_files/singleton/summary/overall_summary_v2.csv")
        self.communication_summary = pd.read_csv("./predicted_files/singleton/summary/communication_summary_v2.csv")
        self.tips_errors = pd.read_csv("./predicted_files/singleton/summary/tips_errors_v2.csv")
